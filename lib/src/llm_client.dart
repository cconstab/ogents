...
class LLMClient {
  ...
  Future<bool> _sendLLMRequest(Map<String, dynamic> requestData) async {
    try {
      ...
      if (result.atClientException != null) {
        logger.warning('LLM request notification failed: ${result.atClientException}');
        return false;
      }
  ...
  Future<String?> _waitForLLMResponse(String requestId) async {
    ...
    try {
      ...
      subscription = atClient.notificationService
          ...
          .listen((notification) {
        try {
          final responseData = jsonDecode(notification.value!) as Map<String, dynamic>;
  ...
  Future<void> startLLMService({
    required Future<String?> Function(String prompt, Map<String, dynamic> context) onRequest,
  }) async {
  ...
  Future<void> _handleLLMRequest(
    ...
    Future<String?> Function(String prompt, Map<String, dynamic> context) onRequest,
  ) async {
    try {
      final requestData = jsonDecode(notification.value!) as Map<String, dynamic>;
      ...
      if (response != null) {
        ...
        await _sendLLMResponse(sender, requestId, 'Sorry, I was unable to process your request.');
      }
  ...
  Future<void> _sendLLMResponse(String toAtSign, String requestId, String response) async {
    try {
      final responseData = {
